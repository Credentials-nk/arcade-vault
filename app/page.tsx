  ...
  return (
    <div className="home fade-in">
      ...
      <section className="home-hero">
        ...
        <div className="home-hero-inner">
          ...
          <div className="home-ctas">
            <button className="btn xl pulse" onClick={() => router.push('/library')}>
              ▶ EXPLORAR JUEGOS
            </button>
        ...
        <div className="mini-rail">
          {GAMES.slice(0, 6).map((g) => (
            <MiniCard
              key={g.id}
              game={g}
              onClick={() => router.push(g.playRoute ?? `/game/${g.id}`)}
            />
          ))}
        </div>
        <div style={{ textAlign: 'center', marginTop: 24 }}>
          <button className="btn lg" onClick={() => router.push('/library')}>
        ...
        <div className="activity-grid">
          ...
          <div className="activity-card">
            <div className="ac-head">
              ...
              <button className="lb-link" onClick={() => router.push('/hall')}>
                VER SALÓN →
              </button>
            </div>
          ...
          <div className="pricing-faq">
            <div className="faq-item">
              ...
              <div className="faq-a">
                ...
                hay versión &ldquo;premium&rdquo; escondida.
              </div>
            </div>
            <div className="faq-item">
      ...
      <section className="home-final reveal">
        ...
        <button className="btn xl pulse final-cta" onClick={() => router.push('/library')}>
          INSERTAR MONEDA →
        </button>
